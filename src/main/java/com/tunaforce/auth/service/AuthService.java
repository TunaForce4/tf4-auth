...
public class AuthService {
    ...
    public LoginResponseDto login(LoginRequestDto loginRequestDto) {
        ...
        return new LoginResponseDto(Jwts.builder()
                ...
                // 삭제 정보도 토큰에 포함(폴백 시 삭제 사용자 차단용)
                .claim("deletedAt", user.getDeletedAt() != null ? user.getDeletedAt().toString() : null)
                .claim("deletedBy", user.getDeletedBy() != null ? user.getDeletedBy().toString() : null)
                .issuer(issuer)
